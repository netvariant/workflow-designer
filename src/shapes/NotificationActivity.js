/* eslint-disable */
let NotificationActivity = draw2d.shape.layout.VerticalLayout.extend({
  ...
  init: function (attr) {
    ...
    this.userData = {
      activityDescription: '',
      notificationTypeEnumId: 'WF_NOTIFY_EMAIL',
      crowds: [],
      message: ''
    };
...
window.NotificationActivity = NotificationActivity;
