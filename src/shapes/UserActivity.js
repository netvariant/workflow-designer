/* eslint-disable */
let UserActivity = draw2d.shape.layout.VerticalLayout.extend({
  ...
  addPorts: function (object) {
    ...
    // timeout port
    let timeoutPort = this.createPort("output", new draw2d.layout.locator.BottomLocator());
    timeoutPort.setBackgroundColor("#FFA500");
    timeoutPort.setName("TIMEOUT");
    timeoutPort.setMaxFanOut(20);
  },
